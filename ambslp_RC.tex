...
The AMB RC module class is the \textbf{\texttt{\index{ReadoutModule\_Ambslp}}},
inheriting
...
\item[PatternBankConf:] link to an OKS object of the \textbf{\index{PatternBankConf}} type,
